...
sqlite3 budget-badger.db "CREATE TABLE cards (card_id INTEGER PRIMARY KEY NOT NULL UNIQUE, card_name TEXT NOT NULL UNIQUE);" && echo "Success: table cards created"
